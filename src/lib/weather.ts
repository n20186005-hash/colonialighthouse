...
export type Lang = 'es' | 'en' | 'zh' | 'gn' | 'pt';

// WMO weather code -> localized short description + glyph.
const WMO: Record<number, { es: string; en: string; zh: string; gn: string; pt: string; icon: string }> = {
  0: { es: 'Despejado', en: 'Clear', zh: '晴朗', gn: 'Claro', pt: 'Limpo', icon: '☀️' },
  1: { es: 'Mayormente despejado', en: 'Mainly clear', zh: '晴间多云', gn: 'Oĩva claro', pt: 'Predomina limpo', icon: '🌤️' },
  2: { es: 'Parcialmente nublado', en: 'Partly cloudy', zh: '局部多云', gn: 'Parcialmente nublado', pt: 'Parcialmente nublado', icon: '⛅' },
  3: { es: 'Nublado', en: 'Overcast', zh: '阴', gn: 'Nublado', pt: 'Nublado', icon: '☁️' },
  45: { es: 'Niebla', en: 'Fog', zh: '雾', gn: 'Kaʼaru', pt: 'Nevoeiro', icon: '🌫️' },
  48: { es: 'Niebla helada', en: 'Rime fog', zh: '雾凇', gn: 'Kaʼaru rupy', pt: 'Nevoeiro gelado', icon: '🌫️' },
  51: { es: 'Llovizna leve', en: 'Light drizzle', zh: '小毛毛雨', gn: 'Arapy mitã', pt: 'Garoa leve', icon: '🌦️' },
  53: { es: 'Llovizna', en: 'Drizzle', zh: '毛毛雨', gn: 'Arapy', pt: 'Garoa', icon: '🌦️' },
  55: { es: 'Llovizna densa', en: 'Dense drizzle', zh: '浓毛毛雨', gn: 'Arapy tuichakue', pt: 'Garoa densa', icon: '🌦️' },
  56: { es: 'Lluvia helada', en: 'Freezing drizzle', zh: '冻毛毛雨', gn: 'Arapy rupy', pt: 'Chuva congelante', icon: '🌧️' },
  57: { es: 'Lluvia helada', en: 'Freezing drizzle', zh: '冻毛毛雨', gn: 'Arapy rupy', pt: 'Chuva congelante', icon: '🌧️' },
  61: { es: 'Lluvia leve', en: 'Slight rain', zh: '小雨', gn: 'Arapy michĩ', pt: 'Chuva leve', icon: '🌧️' },
  63: { es: 'Lluvia moderada', en: 'Moderate rain', zh: '中雨', gn: 'Arapy', pt: 'Chuva moderada', icon: '🌧️' },
  65: { es: 'Lluvia intensa', en: 'Heavy rain', zh: '大雨', gn: 'Arapy tuicha', pt: 'Chuva intensa', icon: '🌧️' },
  66: { es: 'Lluvia helada', en: 'Freezing rain', zh: '冻雨', gn: 'Arapy rupy', pt: 'Chuva congelante', icon: '🌧️' },
  67: { es: 'Lluvia helada', en: 'Freezing rain', zh: '冻雨', gn: 'Arapy rupy', pt: 'Chuva congelante', icon: '🌧️' },
  71: { es: 'Nieve leve', en: 'Slight snow', zh: '小雪', gn: 'Yvu michĩ', pt: 'Neve leve', icon: '🌨️' },
  73: { es: 'Nieve moderada', en: 'Moderate snow', zh: '中雪', gn: 'Yvu', pt: 'Neve moderada', icon: '🌨️' },
  75: { es: 'Nieve intensa', en: 'Heavy snow', zh: '大雪', gn: 'Yvu tuicha', pt: 'Neve intensa', icon: '🌨️' },
  77: { es: 'Granos de nieve', en: 'Snow grains', zh: '雪粒', gn: 'Yvu', pt: 'Grãos de neve', icon: '🌨️' },
  80: { es: 'Chubascos leves', en: 'Slight showers', zh: '小阵雨', gn: 'Arapy', pt: 'Pancadas leves', icon: '🌦️' },
  81: { es: 'Chubascos', en: 'Showers', zh: '阵雨', gn: 'Arapy', pt: 'Pancadas', icon: '🌧️' },
  82: { es: 'Chubascos intensos', en: 'Violent showers', zh: '强阵雨', gn: 'Arapy tuicha', pt: 'Pancadas fortes', icon: '⛈️' },
  85: { es: 'Chubascos de nieve', en: 'Snow showers', zh: '阵雪', gn: 'Yvu', pt: 'Pancadas de neve', icon: '🌨️' },
  86: { es: 'Chubascos de nieve', en: 'Snow showers', zh: '阵雪', gn: 'Yvu', pt: 'Pancadas de neve', icon: '🌨️' },
  95: { es: 'Tormenta eléctrica', en: 'Thunderstorm', zh: '雷暴', gn: 'Arai', pt: 'Tempestade', icon: '⛈️' },
  96: { es: 'Tormenta con granizo', en: 'Thunderstorm w/ hail', zh: '雷暴伴冰雹', gn: 'Arai', pt: 'Tempestade com granizo', icon: '⛈️' },
  99: { es: 'Tormenta con granizo', en: 'Thunderstorm w/ hail', zh: '雷暴伴冰雹', gn: 'Arai', pt: 'Tempestade com granizo', icon: '⛈️' },
};
...
const ADVICE: Record<Lang, {
  ...
  pt: {
    cold: 'Temperaturas baixas: vista-se em camadas, com gorro e luvas; as manhãs e as noites à beira do Rio da Prata são frescas.',
    hot: 'Está quente: roupas leves, chapéu e proteção solar; evite a exposição ao meio-dia.',
    layering: 'Grande variação entre dia e noite: leve um casaco leve para vestir ou tirar conforme as horas.',
    windy: 'Vento notável: o passeio de barco pelo rio e algumas atividades ao ar livre podem ser suspensos; o chapéu voa, melhor evitar vestido longo e solto.',
    mild: 'Vista camadas leves; a temperatura à beira do rio muda ao longo do dia.',
    sunny: 'Céu limpo: bom momento para subir ao farol e percorrer o centro histórico; a luz é melhor ao amanhecer e ao pôr do sol.',
    cloudy: 'Luz suave e sem sol forte: ideal para fotografar o Bairro Histórico e caminhar por longas horas.',
    rainPlan: 'Se chover, priorize o interior do museu e um café; a subida ao farol pode fechar.',
    slippery: 'Chão molhado: caminhe com cuidado pelas pedras e pelas muralhas de pedra.',
    noOutdoor: 'Não convém estar ao ar livre; os passeios de barco e o bondinho podem estar fora de serviço.',
    waterClose: 'As atividades na água e à beira do rio provavelmente fecham; não entre na água.',
    foggy: 'Visibilidade reduzida: não é um bom momento para subir ao farol nem para ver o rio.',
    umbrella: 'Leve guarda-chuva ou capa de chuva: a chuva é bem provável hoje e nos próximos dias.',
    foldUmbrella: 'Leve um guarda-chuva dobrável: há garoa e o chão está escorregadio.',
    raincoat: 'Leve capa de chuva (melhor que o guarda-chuva longo com vento): a chuva é intensa.',
    sunItems: 'Use protetor solar, óculos de sol e boné; a radiação é forte.',
    water: 'Leve água, especialmente nos roteiros a pé pelo Bairro Histórico.',
    mask: 'Leve máscara se o nevoeiro ou o ar incomodarem ao caminhar.',
    stormAlert: 'Cuidado com os raios: não suba ao farol, não entre no rio nem se abrigue sob árvores; as atividades aquáticas costumam fechar.',
    windRisk: 'Vento forte: afaste-se de placas e das pedras à beira do rio; os passeios aquáticos provavelmente fecham.',
    heavyRainRisk: 'Chuva intensa: evite as áreas baixas e a beira da água; o barco e o bondinho podem ser suspensos.',
    fogRisk: 'Baixa visibilidade: a balsa e os voos costumam atrasar; não é um bom momento para as vistas.',
  },
};
